                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 12) {
                        HighlightTilePlaceholder(
                            ...
                            color: .orange,
                            title: "Workouts",
                            body: "You walked 5.4 kilometres during your most recent workout."
                        )
                        HighlightTilePlaceholder(
                            icon: "flame.fill",
                            color: .orange,
                            title: "Active Energy",
                            body: "The last 7 days you burned an average of 210 kilocalories a day."
                        )
                        HighlightTilePlaceholder(
                            icon: "heart.fill",
                            color: .red,
                            title: "Heart Rate: Workout",
                            body: "Your heart rate range during your recent walk was 104–133 beats per minute."
                        )
                    }
                    .padding(.horizontal, 20)
                }
